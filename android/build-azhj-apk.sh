...
for marker in \
  ...
  'KernelSU control failed ' \
  'M3Q_AZHJ_KSU_PROBE_UNVERIFIED:' \
...
echo 'AZHJ_STRICT_KSU_PREFLIGHT_ARTIFACT_GATE=PASS'
...
AZHJ_PRELOADER_STRICT_DAEMON_KSU_PROBE_GATE=PASS
AZHJ_STRICT_KSU_PREFLIGHT_GATE=PASS
AZHJ_STRICT_KSU_PREFLIGHT_ARTIFACT_GATE=PASS
